...
/**
 * Fixed-position overlay so opening it never affects document flow or moves
 * sibling elements (the grid behind it stays 100% frozen). Full-screen below
 * `sm:`, a centered card above it. Closes on Escape, backdrop click, or the
 * explicit X button.
 */
