        ...
        <div className="mt-10 grid grid-cols-1 gap-3 sm:mt-14 sm:grid-cols-3 sm:gap-4">
          {content.items.map((item, i) => (
            <motion.div
              ...
              className="group flex flex-col rounded-2xl border border-white/10 bg-black/40 p-6 backdrop-blur-md transition-colors duration-500 hover:border-[#C06C4C]/60 sm:p-8"
            >
              <span
              ...
              <p className="mt-3 text-sm leading-relaxed text-zinc-400 sm:text-[15px]">{item.body}</p>
            </motion.div>
          ))}
        </div>
      </div>
