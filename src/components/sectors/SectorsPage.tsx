      ...
      <main className="relative z-10 overflow-x-hidden bg-white">
        <section className="px-5 pb-12 pt-28 sm:px-6 sm:pb-14 sm:pt-32">
          <div className="mx-auto max-w-6xl">
            ...
            >
              ...
              <span className="text-slate-600">{content.breadcrumb}</span>
            </nav>
            ...
            <motion.h1
              ...
              className="mt-5 max-w-3xl text-balance text-4xl font-semibold leading-[1.05] tracking-[-0.04em] text-slate-900 sm:text-5xl md:text-6xl"
            ...
            <motion.p
              ...
              className="mt-6 max-w-2xl text-pretty text-base leading-relaxed text-slate-600 md:text-lg"
            >
              {content.intro}
            </motion.p>
          </div>
        ...
        <section className="px-5 pb-28 sm:px-6 sm:pb-36">
          <div className="mx-auto flex max-w-6xl justify-center">
            <Link
              href={`${home}/contact`}
              className="rounded-full bg-sky-500 hover:bg-sky-600 px-8 py-4 text-center text-[15px] font-medium text-white transition-transform duration-300 hover:-translate-y-0.5"
            >
              {content.cta}
            </Link>
          </div>
