...
const pl: ShowcaseContent = {
  ...
  chat: {
    ...
    messages: [
      ...
      { from: "agent", time: "22:49", text: "Wtedy różnicę w cenie materiału dopisujemy do kosztorysu, robocizna zostaje bez zmian. Konkretnej kwoty nie podam, bo to już liczy kosztorysant." },
    ...
    work: [
      ...
      "Brakuje metrażu i zakresu, więc dopytuję zamiast zgadywać",
      "Sięgam po cennik: pakiet standard 1 850 zł/m²",
      "Liczę: 78 × 1 850 = 144 300 zł netto",
      "Czytam kartę usługi: co wchodzi w pakiet",
      "Płytki spoza listy wykraczają poza cennik, więc nie zmyślam",
  ...
  call: {
    ...
    outcomeTitle: "Pomiar u klienta, wtorek 9:00",
    outcomeNote: "SMS potwierdzający wysłany · transkrypt w karcie klienta",
  },

  funnel: {
    introHead: "Ktoś klika Waszą reklamę i zostawia numer. Zwykle oddzwaniacie za kilka godzin, a ",
    ...
    leads: [
      ...
      },
      {
        who: "Tomasz R.",
        source: "reklamy na Facebooku",
        answers: ["Nie odpowiedział", "brak", "brak"],
        pass: false,
...
const en: ShowcaseContent = {
  ...
  chat: {
    ...
    messages: [
      ...
      { from: "agent", time: "22:49", text: "Then the material price difference is added to the estimate and labour stays the same. I won't quote a figure, because that one is for our estimator." },
    ...
    work: [
      ...
      "Area and scope missing, so asking instead of guessing",
      ...
      "Tiles off-list fall outside the price list, so not making it up",
  ...
  call: {
    ...
    outcomeTitle: "Site survey, Tuesday 9:00",
    outcomeNote: "Confirmation text sent · transcript on the client record",
  },

  funnel: {
    introHead: "Someone clicks your ad and leaves a number. You usually call back hours later, while ",
